          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-brand-primary mb-6">
                ...
                <p className="mb-4">Son aquéllas que se envían al equipo terminal del usuario desde www.serviciosandalusi.com.</p>
                
                <p className="font-semibold mb-2">Cookies de terceros:</p>
                <p>Son aquéllas que se envían al equipo terminal del usuario desde un equipo o dominio que no es gestionado por Jose Manuel Pozo Copado sino por otra entidad que trata los datos obtenidos través de las cookies. Dado que son estos terceros quienes proceden a su implementación, el bloqueo y desinstalación de las mismas se rige por sus condiciones y mecanismos específicos.</p>
              </div>
            ...
            <section>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                ...
                <p className="mt-2">
                  En www.serviciosandalusi.com utilizamos cookies propias, de sesión, técnicas y analíticas. También empleamos cookies de terceros. Al navegar y continuar en nuestra web o al haber aceptado expresamente el uso de cookies, nos indicas que estás consintiendo el uso de las cookies antes enunciadas, y en las condiciones contenidas en la presente Política de Cookies.
                </p>
              </div>

              <p>
                Jose Manuel Pozo Copado puede modificar esta Política de Cookies en función de exigencias reglamentarias, legislativas o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos. En el caso que se produzcan cambios significativos en esta Política de Cookies, se comunicará debidamente a los usuarios.
              </p>
            </section>
          </div>
        </div>
