...
const zones = [
  { 
    ...
    subareas: ['Casco Antiguo', 'Arenal', 'Alfalfa'],
    image: 'https://iili.io/fLGfg0G.jpg'
  },
  { 
    name: 'Triana y Remedios', 
    subareas: ['Triana', 'Los Remedios', 'Tablada'],
    image: 'https://iili.io/fLGnvp4.png'
  },
  { 
    name: 'Macarena y Norte', 
    subareas: ['Macarena', 'Pino Montano', 'San Jerónimo', 'La Barzola'],
    image: 'https://iili.io/fLGxvX2.png'
  },
  { 
    name: 'Nervión y Santa Justa', 
    subareas: ['Nervión', 'San Pablo', 'Santa Justa'],
    image: 'https://iili.io/fLG5MTg.png'
  },
  { 
    name: 'Sevilla Este', 
    subareas: ['Cerro del Águila', 'Torreblanca', 'Palmete'],
    image: 'https://iili.io/fLGaEy7.png'
  },
  { 
    name: 'Sur y Bellavista', 
    subareas: ['Bellavista', 'La Palmera', 'Heliópolis'],
    image: 'https://iili.io/fLGMxiF.png'
  }
];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8 text-white">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 uppercase tracking-tight">
              ÁREAS DE <span className="text-brand-primary">COBERTURA</span>
            </h2>
            <p className="text-gray-400 font-medium">
              Desplazamiento <span className="text-brand-primary font-bold">gratuito</span> en servicios urgentes dentro de Sevilla Capital.
            </p>
          </div>
          <div className="bg-brand-primary/10 border border-brand-primary/20 p-6 rounded-2xl hidden md:block">
            <div className="text-brand-primary font-black text-2xl">30 MIN</div>
            <div className="text-white text-[10px] uppercase font-bold tracking-widest">Tiempo medio de respuesta</div>
          </div>
        </div>
