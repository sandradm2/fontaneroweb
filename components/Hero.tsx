...
const Hero: React.FC = () => {
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url(https://iili.io/fLNc707.jpg)',
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-brand-primary/5 clip-path-hero hidden lg:block"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 py-8 sm:py-12">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left text-white">
            ...
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-bold mb-4 sm:mb-6 leading-tight tracking-tight">
              <span className="block">SERVICIOS</span>
              <span className="text-brand-primary font-nova normal-case">Andalusí</span>
            </h1>
            ...
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0 mb-8 sm:mb-10 leading-relaxed font-medium">
              Soluciones integrales de <span className="text-white font-semibold">Reformas, Fontanería y Electricidad</span> en Sevilla. 
              <span className="block mt-1">Más de 20 años transformando hogares con el estándar de calidad europeo.</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10">
              ...
              >
                <div className="flex flex-col items-start leading-tight">
                  <span className="text-[9px] sm:text-[10px] uppercase opacity-80 tracking-widest">Llamada Directa</span>
                  <span className="text-sm sm:text-lg">681 269 974</span>
                </div>
                <Phone size={20} className="flex-shrink-0 group-hover:rotate-12 transition-transform" />
              </a>
              <a 
              ...
              >
                ...
                <MessageCircle size={20} className="flex-shrink-0 text-brand-primary" />
              </a>
            </div>
          ...
          {/* Optional Visual Element / Image Box - Visible en tablet y desktop */}
          <div className="w-full lg:w-2/5 relative hidden md:block mt-12 lg:mt-0">
            <div className="relative z-10 rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl border-4 lg:border-8 border-white/5">
              ...
              <div className="absolute -bottom-4 -left-4 bg-brand-primary p-4 sm:p-5 lg:p-6 rounded-xl lg:rounded-2xl shadow-xl text-brand-secondary z-20">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-black">+20</div>
                <div className="text-[10px] sm:text-xs font-bold uppercase tracking-widest opacity-80">Años de experiencia</div>
              </div>
            </div>
          </div>
        </div>
