...
export default function UrgencyBanner() {
    return (
        <section className="bg-brand-light py-20" aria-labelledby="urgency-heading">
            <div className="container mx-auto px-4">
                <div className="bg-brand-secondary bg-[linear-gradient(135deg,_#0a0a0a_0%,_#1a1814_50%,_#0a0a0a_100%)] rounded-[2.5rem] p-10 md:p-16 flex flex-col items-center text-center relative overflow-hidden border border-brand-primary/20">
                    ...
                    <h2 id="urgency-heading" className="text-3xl md:text-5xl font-extrabold text-white mb-6 uppercase tracking-tight leading-tight">
                        ASISTENCIA{" "}
                    ...
                    <p className="text-lg text-gray-400 max-w-2xl mb-12 font-medium">
                        ¿Avería crítica? Nuestros técnicos de guardia están operativos en
                        Sevilla capital para resolver tu urgencia de fontanería o
                        electricidad
                    </p>
