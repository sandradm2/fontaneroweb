...
export const metadata: Metadata = {
    title: "Aviso Legal",
    description: `Aviso legal y condiciones generales de uso del sitio web de ${siteConfig.name}.`,
...
export default function AvisoLegalPage() {
    return (
        <div className="min-h-screen flex flex-col pt-32 pb-20">
            <BreadcrumbSchema items={[{ name: "Aviso Legal", href: "/aviso-legal" }]} />
